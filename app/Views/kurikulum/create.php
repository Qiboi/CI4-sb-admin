...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Tambah Data Kurikulum</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url('/kurikulum/store')?>" method="post">
            <?= csrf_field(); ?>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="text" id="kode_matkul" name="kode_matkul">
                </div>
                <div class="mb-3">
                    <label for="nama_matkul">Nama Matkul</label>
                    <input class="form-control" type="text" id="nama_matkul" name="nama_matkul">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input class="form-control" type="number" id="konversi" name="konversi">
                </div>
                <div class="mb-3">
